    ...
    <div className={`bottom_nav ${set ? 'nav_up' : 'nav_down'}`} >
      <div>
        ...
        <ul className='nav_ul'>
            ...
            <li title="Home">
            <Link to="/"><img className='nav_icon' src={home} alt="Home" /></Link></li>
            
            <li title="Education"><Link to="education"> <img  className='nav_icon' src={education} alt="Education" /></Link></li>
            <li title="Project"><Link to="project"><img className='nav_icon' src={project} alt="Project" /></Link> </li>
